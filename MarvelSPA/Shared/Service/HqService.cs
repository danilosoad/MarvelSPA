...
namespace MarvelSPA.Shared.Service
{
    public static class HqService
    {
        public static async Task<Resposta> BuscarHqsByCharacterId(int id)
        {
            ...
            var url = $"https://gateway.marvel.com/v1/public/characters/{id}/comics?apikey=d659481d3f02d81e5ec1b11d8f40a089&hash=f4cc18f4da2791ef5d1d06b6a8d5c7d0&ts=1637856513";
